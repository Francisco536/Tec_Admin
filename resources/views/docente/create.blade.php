    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="docente"  name="docente" action="{{ route('store.docente') }}" onsubmit="verificarPasswords();">
                        @csrf
                        ...
                        <div class="row mb-0" style="text-align: center">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{route('lista.docente')}}" class="btn btn-danger">
                                    {{ __('Cancelar') }}
                                </a>
                            </div>
                        </div>
...
function capitalize(str){
    ...
    //Validar password
    var docenteLog = document.getElementById('docente');
    docenteLog.addEventListener("submit", (e) => {
